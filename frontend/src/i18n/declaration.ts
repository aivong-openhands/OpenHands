...
export enum I18nKey {
  ...
  BITBUCKET$MODE_LABEL = "BITBUCKET$MODE_LABEL",
  BITBUCKET$MODE_OPTION_CLOUD = "BITBUCKET$MODE_OPTION_CLOUD",
  BITBUCKET$MODE_OPTION_SERVER = "BITBUCKET$MODE_OPTION_SERVER",
